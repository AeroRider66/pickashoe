...
const classSpecificInfo = function() {
    ...
    .then(function(levels) {
        ...
        for (i = 0; i < 5; i++) {
            ...
            cantrips[i].textContent = "Cantrips for this level: " + levels[i].spellcasting.cantrips_known;
            spellsByLevel1[i].textContent = "Level 1 spell slots: " + levels[i].spellcasting.spell_slots_level_1;
            spellsByLevel2[i].textContent = "Level 2 spell slots: " + levels[i].spellcasting.spell_slots_level_2;
            spellsByLevel3[i].textContent = "Level 3 spell slots: " + levels[i].spellcasting.spell_slots_level_3;
            arcaneRecovery[i].textContent = "Arcane Recovery: " + levels[i].class_specific.arcane_recovery_levels;
        ...
        for (i = 0; i < 5; i++) {
            ...
            informationArea5.append(cantrips)[i];
            informationArea5.append(spellsByLevel1[i]);
            informationArea5.append(spellsByLevel2)[i];
            informationArea5.append(spellsByLevel3)[i];
            informationArea5.append(arcaneRecovery[i]);
        }
    })
}
